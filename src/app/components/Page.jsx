                                        ...
                                        <div className=' col-span-2'>
                                                <div className=' bg-slate-200 shadow-lg min-h-screen p-5'>
                                                        ...
                                                        <div className=' flex flex-col gap-9'>
                                                                <button onClick={() => tabchanges("tab1")} className={` ${first === "tab1" &&" bg-slate-400" } font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>January</button>
                                                                <button onClick={() => tabchanges("tab2")} className={` ${first === "tab2" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>Febuary</button>
                                                                <button onClick={() => tabchanges("tab3")} className={` ${first === "tab3" &&" bg-slate-400"} font-medium text-black px-5 py-3   rounded-lg border border-slate-400 `}>March</button>
                                                                <button onClick={() => tabchanges("tab4")} className={` ${first === "tab4" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>April</button>
                                                                <button onClick={() => tabchanges("tab5")} className={` ${first === "tab5" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>May</button>
                                                                <button onClick={() => tabchanges("tab6")} className={` ${first === "tab6" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>June</button>
                                                                <button onClick={() => tabchanges("tab7")} className={` ${first === "tab7" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>July</button>
                                                                <button onClick={() => tabchanges("tab8")} className={` ${first === "tab8" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>August</button>
                                                                <button onClick={() => tabchanges("tab9")} className={` ${first === "tab9" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>September</button>
                                                                <button onClick={() => tabchanges("tab10")} className={` ${first === "tab10" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>October</button>
                                                                <button onClick={() => tabchanges("tab11")} className={` ${first === "tab11" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>November</button>
                                                                <button onClick={() => tabchanges("tab12")} className={` ${first === "tab12" &&" bg-slate-400"} font-medium text-black px-5 py-3  rounded-lg border border-slate-400 `}>December</button>
                                                        </div>
                                                </div>
                                        </div>
                                                ...
                                                }
                                                {
                                                        ...
                                                        <div className=' bg-slate-400 p-4 rounded-2xl w-full h-[1080px] overflow-hidden overflow-y-scroll flex flex-col'>
                                                                        ...
                                                                        <div className=' bg-white flex gap-7 p-5 rounded-2xl '>
                                                                                <div className=' gap-2 flex'>
                                                                                        <p className='font-bold text-xl'>1.</p>
                                                                                    <Image className=' object-cover rounded-xl' src="/image/noblemid.png" alt='img' height={300} width={300}/>
                                                                
                                                                                </div>
                                                                                <div className=' flex gap-6'>
                                                                                        <div>
                                                                                        <p className=' font-bold pb-3 text-xl'>NobleMind</p>
                                                                                                <div className=' flex items-center gap-2'>
                                                                                                        <p className='font-bold'>Github-Link:-</p>
                                                                                                        <a href="https://github.com/sanjuverma373/noblemind.git" target='_blank'>https://github.com/sanjuverma373/noblemind.git</a>
                                                                                                </div>
                                                                                                <div className=' flex items-center gap-2 pt-2'>
                                                                                                        <p className='font-bold'>Vercel-Link:-</p>
                                                                                                        <a href="https://noblemind-eta.vercel.app/" target='_blank'>https://noblemind-eta.vercel.app/</a>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                                                        </div>                                                                                                                                        
                                                                        <div className=' bg-white flex gap-7 p-5 mt-7 rounded-2xl '>
                                                                                ...
                                                                                <div className=' flex gap-6'>
                                                                                        <div>
                                                                                        <p className=' font-bold pb-3 text-xl'>Email with Form validation</p>
                                                                                                <div className=' flex items-center gap-2'>
                                                                                                        <p className='font-bold'>Github-Link:-</p>
                                                                                                        <a href="https://github.com/sanjuverma373/emailform.git" target='_blank'>https://github.com/sanjuverma373/emailform.git</a>
                                                                                                </div>
                                                                                                <div className=' flex items-center gap-2 pt-2'>
                                                                                                        <p className='font-bold'>Vercel-Link:-</p>
                                                                                                        <a href="https://emailform-zeta.vercel.app/" target='_blank'>https://emailform-zeta.vercel.app/</a>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                                                        </div>                                                                                                                                        
                                                ...
                                                }
                                                {
                                                        ...
                                                        <div className=' bg-slate-400 p-4 rounded-2xl w-full h-[1080px] overflow-hidden overflow-y-scroll flex flex-col'>
                                                                        ...
                                                                        <div className=' bg-white flex gap-7 p-5 rounded-2xl  '>
                                                                                ...
                                                                                <div className=' flex gap-6'>
                                                                                        ...
                                                                                        <p className=' font-bold pb-3 text-xl'>Invest-Ai</p>
                                                                                                <div className=' flex items-center gap-2'>
                                                                                                        <p className='font-bold'>Github-Link:-</p>
                                                                                                        <a href="https://github.com/sanjuverma373/invest-ai.git" target='_blank'>https:/sanjuverma373/invest-ai.git</a>
                                                                                                </div>
                                                                                                <div className=' flex items-center gap-2 pt-2'>
                                                                                                        <p className='font-bold'>Vercel-Link:-</p>
                                                                        ...
                                                                        <div className=' bg-white flex gap-7 p-5 rounded-2xl mt-7  '>
                                                                                <div className=' gap-2 flex'>
                                                                                        <p className='font-bold text-xl'>2.</p>
                                                                                    <Image className=' object-cover rounded-xl' src="/image/chirp.png" alt='img' height={300} width={300}/>
                                                                
                                                                                </div>
                                                                                <div className=' flex gap-6'>
                                                                                        <div>
                                                                                        <p className=' font-bold pb-3 text-xl'>Chrip</p>
                                                                                                <div className=' flex items-center gap-2'>
                                                                                                        <p className='font-bold'>Github-Link:-</p>
                                                                                                        <a href="https://github.com/sanjuverma373/chirp.git" target='_blank'>https:/sanjuverma373/chirp.git</a>
                                                                                                </div>
                                                                                                <div className=' flex items-center gap-2 pt-2'>
                                                                                                        <p className='font-bold'>Vercel-Link:-</p>
                                                                                                        <a href="https://chirp-five-jade.vercel.app/" target='_blank'>https://chirp-five-jade.vercel.app/</a>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                                                        </div>                                                                                                                                        
                                                                        <div className=' bg-white flex gap-7 p-5 rounded-2xl mt-7 '>
                                                                                <div className=' gap-2 flex'>
                                                                                        <p className='font-bold text-xl'>3.</p>
                                                                                    <Image className=' object-cover rounded-xl' src="/image/aiStocks.png" alt='img' height={300} width={300}/>
                                                                
                                                                                </div>
                                                                                <div className=' flex gap-6'>
                                                                                        <div>
                                                                                        <p className=' font-bold pb-3 text-xl'>Ai Stocks</p>
                                                                                                <div className=' flex items-center gap-2'>
                                                                                                        <p className='font-bold'>Github-Link:-</p>
                                                                                                        <a href="https://github.com/prince-372/navdia" target='_blank'>https://github.com/prince-372/navdia</a>
                                                                                                </div>
                                                                                                <div className=' flex items-center gap-2 pt-2'>
                                                                                                        <p className='font-bold'>Vercel-Link:-</p>
                                                                                                        <a href="https://navdia.vercel.app/" target='_blank'>https://navdia.vercel.app/</a>
                                                                                                </div>
                                                                                        </div>
                                                                                </div>
                                                                        </div>                                                                                                                                        
